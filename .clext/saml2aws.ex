...
CLIV_E_NAME="${CLIV_E_NAME:-saml2aws}"
CLIV_E_REV="0.3.0"
CLIV_E_BIN_NAME="${CLIV_E_BIN_NAME:-$CLIV_E_NAME}"
CLIV_E_DLFILE="${CLIV_E_DLFILE:-$CLIV_E_NAME.tar.gz}"
CLIV_E_INSTDIR="${CLIV_E_INSTDIR:-$(pwd)}"
CLIV_E_OS="${CLIV_E_OS:-linux}"
CLIV_E_ARCH="${CLIV_E_ARCH:-amd64}"
CLIV_E_GHREPOAPI="https://api.github.com/repos/Versent/$CLIV_E_NAME"
CLIV_E_BASEURL="https://github.com/Versent/$CLIV_E_NAME/releases/download/v%s/$CLIV_E_NAME""_%s_%s_%s.tar.gz"
