...
CLIV_E_NAME="${CLIV_E_NAME:-terraform-docs}"
CLIV_E_REV="0.1.0"
...
CLIV_E_GHREPOAPI="https://api.github.com/repos/terraform-docs/$CLIV_E_BIN_NAME"
CLIV_E_BASEURL="https://github.com/terraform-docs/$CLIV_E_NAME/releases/download/v%s/$CLIV_E_NAME""-v%s-%s-%s.tar.gz"
