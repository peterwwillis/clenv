...
CLINST_E_NAME="${CLINST_E_NAME:-terraform-docs}"
CLINST_E_REV="0.1.0"
...
CLINST_E_GHREPOAPI="https://api.github.com/repos/terraform-docs/$CLINST_E_BIN_NAME"
CLINST_E_BASEURL="https://github.com/terraform-docs/$CLINST_E_NAME/releases/download/v%s/$CLINST_E_NAME""-v%s-%s-%s.tar.gz"
