...
CLINST_E_NAME="${CLINST_E_NAME:-docker-compose}"
CLINST_E_REV="0.2.0"
...
CLINST_E_GHREPOAPI="https://api.github.com/repos/docker/compose"
CLINST_E_BASEURL="https://github.com/docker/compose/releases/download/%s/$CLINST_E_NAME-%s-%s"
...
_ext_versions () {  clinst -E "$CLINST_E_NAME" -X versions_ghreleases "$CLINST_E_GHREPOAPI" | grep -v 'rc' ;  }
