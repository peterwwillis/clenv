...
CLIV_E_NAME="${CLIV_E_NAME:-docker-compose}"
CLIV_E_REV="0.2.0"
...
CLIV_E_GHREPOAPI="https://api.github.com/repos/docker/compose"
CLIV_E_BASEURL="https://github.com/docker/compose/releases/download/%s/$CLIV_E_NAME-%s-%s"
CLIV_E_BASEURL_ARGS='"${CLIV_E_VERSION}" "${CLIV_E_OS}" "${CLIV_E_ARCH}"'
export CLIV_E_NAME CLIV_E_REV CLIV_E_BIN_NAME CLIV_E_DLFILE

### Extension-specific functions
_ext_versions () {  cliv -E "$CLIV_E_NAME" -X versions_ghreleases "$CLIV_E_GHREPOAPI" | grep -v 'rc' ;  }
