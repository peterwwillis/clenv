...
CLIV_E_PLATFORM="${CLIV_E_PLATFORM:-aws}"
CLIV_E_OS="${CLIV_E_OS:-linux}"
CLIV_E_ARCH="${CLIV_E_ARCH:-amd64}"
CLIV_E_GHREPOAPI="https://api.github.com/repos/GoogleCloudPlatform/$CLIV_E_BIN_NAME"
CLIV_E_BASEURL="https://github.com/GoogleCloudPlatform/$CLIV_E_NAME/releases/download/%s/$CLIV_E_NAME-%s-%s-%s"
CLIV_E_BASEURL_ARGS='"${CLIV_E_VERSION}" "${CLIV_E_PLATFORM}" "${CLIV_E_OS}" "${CLIV_E_ARCH}"'
