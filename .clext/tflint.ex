...
CLINST_E_NAME="${CLINST_E_NAME:-tflint}"
CLINST_E_REV="0.1.0"
...
CLINST_E_GHREPOAPI="https://api.github.com/repos/terraform-linters/$CLINST_E_BIN_NAME"
CLINST_E_BASEURL="https://github.com/terraform-linters/$CLINST_E_NAME/releases/download/v%s/$CLINST_E_NAME""_%s_%s.zip"
