...
CLIV_E_GHREPOAPI="https://api.github.com/repos/tfsec/$CLIV_E_BIN_NAME"
CLIV_E_BASEURL="https://github.com/tfsec/$CLIV_E_NAME/releases/download/v%s/$CLIV_E_NAME""-%s-%s"
