...
CLENV_E_NAME="${CLENV_E_NAME:-tflint}"
CLENV_E_REV="0.1.0"
...
CLENV_E_GHREPOAPI="https://api.github.com/repos/terraform-linters/$CLENV_E_BIN_NAME"
CLENV_E_BASEURL="https://github.com/terraform-linters/$CLENV_E_NAME/releases/download/v%s/$CLENV_E_NAME""_%s_%s.zip"
