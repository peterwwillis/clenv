...
CLIV_E_NAME="${CLIV_E_NAME:-tflint}"
CLIV_E_REV="0.1.0"
...
CLIV_E_GHREPOAPI="https://api.github.com/repos/terraform-linters/$CLIV_E_BIN_NAME"
CLIV_E_BASEURL="https://github.com/terraform-linters/$CLIV_E_NAME/releases/download/v%s/$CLIV_E_NAME""_%s_%s.zip"
