...
CLENV_E_DLFILE="${CLENV_E_DLFILE:-$CLENV_E_NAME.tar.gz}"
CLENV_E_INSTDIR="${CLENV_E_INSTDIR:-$(pwd)}"
CLENV_E_OS="${CLENV_E_OS:-linux}"
CLENV_E_ARCH="${CLENV_E_ARCH:-amd64}"
CLENV_E_GHREPOAPI="https://api.github.com/repos/Versent/$CLENV_E_NAME"
CLENV_E_BASEURL="https://github.com/Versent/$CLENV_E_NAME/releases/download/v%s/$CLENV_E_NAME""_%s_%s_%s.tar.gz"
