...
CLENV_E_NAME="${CLENV_E_NAME:-terragrunt}"
CLENV_E_REV="0.1.0"
...
CLENV_E_GHREPOAPI="https://api.github.com/repos/gruntwork-io/$CLENV_E_BIN_NAME"
CLENV_E_BASEURL="https://github.com/gruntwork-io/$CLENV_E_NAME/releases/download/v%s/$CLENV_E_NAME""_%s_%s"
...
_ext_versions () {  clenv -E "$CLENV_E_NAME" -X versions_ghreleases "$CLENV_E_GHREPOAPI" ;  }
