...
CLIV_E_NAME="${CLIV_E_NAME:-terragrunt}"
CLIV_E_REV="0.1.0"
...
CLIV_E_GHREPOAPI="https://api.github.com/repos/gruntwork-io/$CLIV_E_BIN_NAME"
CLIV_E_BASEURL="https://github.com/gruntwork-io/$CLIV_E_NAME/releases/download/v%s/$CLIV_E_NAME""_%s_%s"
